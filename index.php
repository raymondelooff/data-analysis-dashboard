                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="animated text-center" data-animations="fadeInUpBig">
                            <input data-chart-id="q1-c2" id="chart-toggle" type="checkbox" checked data-toggle="toggle" data-on="Staafdiagram" data-off="Lijndiagram" data-onstyle="dark-blue-bg" data-offstyle="blue-bg" data-width="128">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <h2>Cultuurbezoeken per leeftijdscategorie</h2>
